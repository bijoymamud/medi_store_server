...
def setup_db():
    ...
    yield db"    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>def test_checkout_flow_cod(setup_db):
    db = setup_db
    ...
    assert pay_res.status_code == 200
    assert pay_res.json()["payment_status"] == "paid""    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>@patch("src.modules.orders.router.initiate_sslcommerz_payment")
def test_checkout_payment_methods(mock_ssl, setup_db):
    db = setup_db"    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>    email = "payment_test@example.com"
    existing_user = db.query(User).filter(User.email == email).first()
    if existing_user:
        db.delete(existing_user)
        db.commit()
    ...
    # Mocking SSLCommerz redirect URL
    mock_ssl.return_value = "http://mock-sslcommerz-redirect-url""    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>    # Test SSLCommerz
    client.post(
        "/api/v1/cart/items/",
        headers=headers,
        json={"product_id": product.id, "quantity": 1}
    ...
    assert checkout_ssl.status_code == 200
    assert checkout_ssl.json()["payment_url"] == "http://mock-sslcommerz-redirect-url""    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>def test_order_workflow_approval_and_review(setup_db):
    db = setup_db
...
"    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>    # Test transitioning from cancelled to on_route via PATCH status endpoint
    # First, transition to cancelled
    reject_res = client.post(f"/api/v1/orders/{order_id}/reject", headers=admin_headers)
    assert reject_res.status_code == 200
    assert reject_res.json()["status"] == "cancelled""    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
<truncated 5281 bytes>    # Now patch status back to on_route
    patch_res = client.patch(
        f"/api/v1/orders/{order_id}/status",
        headers=admin_headers,
        json={"status": "on_route"}
    ...
    assert patch_res.status_code == 200
    assert patch_res.json()["status"] == "on_route""    pay_res = client.post(f\"/api/v1/orders/{order_id}/pay-success\", headers=headers)\n    assert pay_res.status_code == 200\n    assert pay_res.json()[\"payment_status\"] == \"paid\"\n\n@patch(\"src.modules.orders.router.initiate_sslcommerz_payment\")\ndef test_checkout_payment_methods(mock_ssl, setup_db):\n    db = setup_db\n\n    email = \"payment_test@example.com\"\n    existing_user = db.query(User).filter(User.email == email).first()\n    if existing_user:\n        db.delete(existing_user)\n        db.commit()\n        \n    reg_res = client.post(\n        \"/api/v1/users/\",\n        data={\n            \"first_name\": \"Payment\",\n            \"last_name\": \"User\",\n            \"email\": email,\n            \"password\": \"password123\",\n            \"phone\": \"01711111111\",\n            \"address\": \"456 Lane, Dhaka\"\n        }\n    )\n    assert reg_res.status_code == 201\n    \n    user = db.query(User).filter(User.email == email).first()\n    assert user is not None\n    user.is_verified = True\n    user.is_active = True\n    db.commit()\n    \n    login_res = client.post(\n        \"/api/v1/auth/login\",\n        json={\"email\": email, \"password\": \"password123\"}\n    )\n    token = login_res.json()[\"tokens\"][\"access\"]\n    headers = {\"Authorization\": f\"Bearer {token}\"}\n    \n    product = db.query(Product).filter(Product.name == \"Test Order Product\").first()\n    \n    # Mocking SSLCommerz redirect URL\n    mock_ssl.return_value = \"http://mock-sslcommerz-redirect-url\"\n\n    # Test SSLCommerz\n    client.post(\n        \"/api/v1/cart/items/\",\n        headers=headers,\n        json={\"product_id\": product.id, \"quantity\": 1}\n    )\n    checkout_ssl = client.post(\n        \"/api/v1/orders/checkout\",\n        headers=headers,\n        json={\n            \"shipping_address\": \"456 Lane, Dhaka\",\n            \"phone\": \"01711111111\",\n            \"payment_method\": \"sslcommerz\"\n        }\n    )\n    assert checkout_ssl.status_code == 200\n    assert checkout_ss
